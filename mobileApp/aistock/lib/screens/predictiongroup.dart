...
class PredictionGroup extends StatefulWidget {
  @override
  _PredictionGroupState createState() {
    return _PredictionGroupState();
  }
}

class _PredictionGroupState extends State<PredictionGroup> {
  //  List list = [
